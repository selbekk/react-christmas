...
export default {
  ...
  lead: `
Context is one of those features of React you rarely need to use - but understanding what it is and how it works makes
...
A *context provider* is a class component that implements the method \`getChildContext()\` and the static property
...
Second, using context makes your components less reusable. You would *have to* wrap any context consumers in its
