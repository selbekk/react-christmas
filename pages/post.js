...
import { PageTitle, LeadParagraph, Paragraph, LinkText } from '../components/typography';
            ...
            <Page title="Post not available yet">
                <ContentContainer>
                    <Center>
                        ...
                        <Paragraph>
                            <LinkText href="/">Go back</LinkText> to the front page and navigate from there.
                        </Paragraph>
                    </Center>
                </ContentContainer>
            </Page>
            ...
            <Page title="Post not found">
                <ContentContainer>
                    <Center>
                        ...
                        <LeadParagraph>Looks like you're trying to access a post that isn't available.</LeadParagraph>
                        <Paragraph>
                            <LinkText href="/">Go back</LinkText> to the front page and navigate from there.
                        </Paragraph>
                    </Center>
        ...
        <Page title={post.title} description={post.lead} ogImage={post.image}>
            ...
            <FadeSlideIn delay=".3s">
                <ContentContainer>
                    ...
                    {author && <AuthorInfo author={author} slug={authorSlug} readingTime={readingTime} />}
